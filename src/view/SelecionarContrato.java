...
public class SelecionarContrato extends javax.swing.JDialog {
    
    private Contrato OContrato = null;
    private int GCliente = 0;

    public Contrato getTextSearch() {
        return this.OContrato;
    }

    public SelecionarContrato(java.awt.Frame parent, boolean modal, int pCliente) {
        super(parent, modal);
        initComponents();
        this.setResizable(false);
        this.setLocationRelativeTo(null);
        GCliente = pCliente;
        new contratoDAO().popularTabela(tbContratos, "", pCliente);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.OContrato = new contratoDAO().consultarId(Integer.parseInt(valor));;
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        new contratoDAO().popularTabela(tbContratos, edBusca.getText(), GCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionarContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelecionarContrato dialog = new SelecionarContrato(new javax.swing.JFrame(), true, 0);
