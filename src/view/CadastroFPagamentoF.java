...
public class CadastroFPagamentoF extends javax.swing.JInternalFrame {
    ...
    public CadastroFPagamentoF() {
        ...
        new formaspagamentoDAO().popularTabela(tbFPagamento, "");
    }
    ...
    private void initComponents() {
        ...
        tbFPagamento = new javax.swing.JTable();
        ...
        tbFPagamento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tbFPagamento);
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (validaCampo()) {
            formaspagamento wFPagamento = new formaspagamento();
            wFPagamento.setCodigo(codigo);
            wFPagamento.setNome(edNome.getText());
            
            formaspagamentoDAO wFPagamentoDAO = new formaspagamentoDAO();

            String retorno = null;
            
            if (wFPagamento.getCodigo() == 0) {
                retorno = wFPagamentoDAO.salvar(wFPagamento);
            } else {
                retorno = wFPagamentoDAO.atualizar(wFPagamento);
            }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        new universidadeDAO().popularTabela(tbFPagamento, edBusca.getText());
    }//GEN-LAST:event_btnPesquisarActionPerformed

    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        String valor = String.valueOf(tbFPagamento.getValueAt(tbFPagamento.getSelectedRow(), 0));

        formaspagamento wFPagameto = new formaspagamentoDAO().consultarId(Integer.parseInt(valor));

        codigo = Integer.parseInt(valor);

        edNome.setText(wFPagameto.getNome());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        String wUsuNome = String.valueOf(tbFPagamento.getValueAt(tbFPagamento.getSelectedRow(), 1));

        Object[] options = { "Confirmar", "Cancelar" };
        int wOpc = JOptionPane.showOptionDialog(null, "Deseja excluir a forma de pagamento: " + wUsuNome,
            "Informação",
        ...
        if (wOpc==0)
        {
            ...
            formaspagamentoDAO wFPagamento = new formaspagamentoDAO();

            String retorno = wFPagamento.excluir(Integer.parseInt(valor));

            if (retorno == null) {
                JOptionPane.showMessageDialog(null, "Registro excluido com sucesso!");
                wFPagamento.popularTabela(tbFPagamento, edBusca.getText());
            } else {
    ...
    private javax.swing.JTable tbFPagamento;
