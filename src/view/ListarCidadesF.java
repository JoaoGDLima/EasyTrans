...
public class ListarCidadesF extends javax.swing.JInternalFrame {


    public ListarCidadesF() {
        initComponents();
        this.setResizable(false);
        cbSituacao.removeAllItems();
        new CombosDAO().popularComboSituacao(cbSituacao);
        
        cbEstados.removeAllItems();
        new CombosDAO().popularCombo("estado","codigo, nome","","nome", cbEstados);
        
        //new CombosDAO().AddComboItem(cbEstados, 0, "Todos");
    }
    ...
    private void initComponents() {
        ...
        cbEstados = new javax.swing.JComboBox<String>();
        ...
        cbEstados.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbEstados, javax.swing.GroupLayout.PREFERRED_SIZE, 305, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String situacao = "";
        String DescEstado = "Todos";
        String DescSituacao = "Todos";
        int estado = 0;

        ComboItens ci = (ComboItens) cbSituacao.getSelectedItem();
        if (ci.getCodigo()==0) {
            situacao = null;
        } else if (ci.getCodigo()==1) {
            situacao = "F";
        ...
        ci = (ComboItens) cbEstados.getSelectedItem();
        if (ci.getCodigo()==0) {
          estado = 0;  
        }
        else
        ...
        try {
            ...
            mapa.put("descEstado", DescEstado);
