...
public class ListarEstadosF extends javax.swing.JInternalFrame {

    public ListarEstadosF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Listar estados cadastrados:");
        setToolTipText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/list_estados.jrxml"));
