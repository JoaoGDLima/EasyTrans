...
public class Formatacao {
    ...
    public static void formatarPlaca(JFormattedTextField campo)
    {
         try {
            ...
            m.setPlaceholderCharacter(' ');
            m.setMask("***-####");
            m.setValidCharacters("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456789");
            campo.setFormatterFactory(null);
            campo.setFormatterFactory(new DefaultFormatterFactory(m));
            campo.setValue(null);
        } catch (Exception e) {
    ...
    public static String formatarCpf(String campo) {
        String wCPFFormatado = null;
        
        try {
            MaskFormatter m = new MaskFormatter("###.###.###-##");
            m.setValueContainsLiteralCharacters(false);
            wCPFFormatado = m.valueToString(campo);
        } catch (Exception e) {
            System.err.println(e);
        }
        
        return wCPFFormatado;
    }
    ...
    public static void formatarInteiro(JFormattedTextField campo, int pQtd) {
        try {
            String wMask = "";
